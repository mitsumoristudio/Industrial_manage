                    ...
                    <div className="mx-auto max-w-2xl lg:max-w-none">
                        ...
                        <div className="lg:grid lg:grid-cols-2 lg:items-start lg:gap-x-8">
                            ...
                            <div className="mx-auto mt-6 hidden w-96 max-w-2xl sm:block lg:max-w-none">
                                <img alt={product.data.name} src={product.data.image} key={product.id}
                            ...
                            <div className="mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0">
                                ...
                                <div className={"flex grid w-full max-w-16 grid-cols-1 mt-4"}>
                                    <select
                                        ...
                                        aria-label={`Quantity, ${product.data.name}`}
                                ...
                                {mockHomeProduct.map((product) => (
                                    <div key={product.id}>
                                        <div className="relative">
                                            <div
                                                className="relative h-72 w-full overflow-hidden rounded-lg cursor-pointer">
                                                <img alt={"productId"} src={product.imageSrc}

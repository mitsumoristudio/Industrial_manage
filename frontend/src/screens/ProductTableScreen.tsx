...
import {useGetProductsPaginationQuery, useDeleteProductMutation} from "../features/productApiSlice";
...
export default function ProductTableScreen() {
    ...
    const handleSearch = (e: any) => {
        ...
        const filtered = products?.data.filter((product :any) => product.name.toLowerCase().includes(term));
                            ...
                            {filteredProducts?.data.map((product :any) => (
                                ...
                                >
                                    ...
                                    <td className='px-6 py-4 whitespace-nowrap'>
                                        <div className='text-sm text-gray-300'>{product.id}</div>
                                    </td>
